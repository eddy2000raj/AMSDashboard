...
$scope.name = mytext;
function customerUpdate() { return " Select count(this) FROM config.amvis.core.AMVisTicket t JOIN config.amvis.core.AMVisAccount acc USING t.AMVisAccount JOIN ariba.user.core.User as AssignedTo using t.AMVisAssignedTo WHERE t.AMVisStatus = 'OPEN' and t.AMVisDateClosed IS NULL AND t.AMVisSubStatus = 'Customer Update' AND AMVisAssignedTo.Name.PrimaryString ='"+mytext+"'";}
$scope.customerUpdate = customerUpdate();
               $http({
				method : "POST",
				headers: {'Content-Type': 'application/x-www-form-urlencoded'},
...
$scope.name = mytext;
function onHold() { return " Select count(this) from AMVisTicket t JOIN ariba.user.core.User u USING t.AMVisAssignedTo WHERE AMVisStatus = 'OPEN' and t.AMVisDateClosed IS NULL AND AMVisSubStatus = 'Customer - Hold' AND AMVisAssignedTo.Name.PrimaryString ='"+$scope.name+"'";}
$scope.onHold = onHold();
               $http({
				method : "POST",
				headers: {'Content-Type': 'application/x-www-form-urlencoded'},
...
$scope.name = mytext;
function PCI() { return " Select count(this) from AMVisTicket t JOIN ariba.user.core.User u USING t.AMVisAssignedTo WHERE AMVisStatus = 'OPEN' and t.AMVisDateClosed IS NULL AND AMVisSubStatus = 'Pending Customer Input' AND AMVisAssignedTo.Name.PrimaryString ='"+$scope.name+"'";}
$scope.PCI = PCI();
               $http({
				method : "POST",
				headers: {'Content-Type': 'application/x-www-form-urlencoded'},
...
$scope.name = mytext;
function TSSTickets() { return " Select count(this) from AMVisTicket t JOIN ariba.user.core.User u USING t.AMVisAssignedTo WHERE AMVisStatus = 'OPEN' and t.AMVisDateClosed IS NULL AND AMVisSubStatus = 'TSS' AND AMVisAssignedTo.Name.PrimaryString ='"+$scope.name+"'";}
