...
$scope.name = mytext;
function OpenTickets() { return " Select count(this) FROM config.amvis.core.AMVisTicket t left outer JOIN config.amvis.core.AMVisAccount acc USING t.AMVisAccount JOIN ariba.user.core.User as AssignedTo using t.AMVisAssignedTo WHERE t.AMVisStatus = 'OPEN' and t.AMVisIsAMSTicket!=false AND AMVisAssignedTo.Name.PrimaryString ='"+mytext+"'";}
