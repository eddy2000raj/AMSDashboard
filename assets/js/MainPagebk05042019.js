...
app.controller('MainCtrl2',function($scope, $http) {
               $http({
				...
				data: { "query" : " SELECT SUBSTRING(AMVisPriority,0,4), count() FROM AMVisTicket WHERE AMVisDateClosed IS NULL AND AMVisStatus = 'OPEN' AND AMVisAccount.AMVisShortName != 'Ariba' and AMVisAssignedTeam ='GS APP MGMT' AND AMVisSubStatus !='Duplicate' and Beginswith(AMVisPriority ,'P',true) and AMVisDateClosed IS NULL GROUP BY SUBSTRING(AMVisPriority,0,4) ", 
						"type" : "pie", 
					  }
				}).then(
				function mySucces(response) {
...
var data = new FormData();
data.append("query", "Select Distinct AMVisShortName,AMVisName,AMVisRegion from config.amvis.core.AMVisAccount Where AMVisCRMID is not null and AMVisName not like '%On Behalf%'");
data.append("useSQL", "");
data.append("type", "table");
...
var data = new FormData();
data.append("query", "Select count(*) FROM config.amvis.core.AMVisTicket t JOIN config.amvis.core.AMVisAccount acc USING t.AMVisAccount JOIN ariba.user.core.User as AssignedTo using t.AMVisAssignedTo WHERE t.AMVisStatus = 'OPEN' AND t.AMVisAssignedTeam = 'GS APP MGMT' AND beginswith(AMVisPriority, 'P1', true) AND t.AMVisAccount.AMVisShortName not in ('Ariba') AND t.AMVisSubStatus !='Duplicate' UNION ALL Select count(*) FROM config.amvis.core.AMVisTicket t JOIN config.amvis.core.AMVisAccount acc USING t.AMVisAccount WHERE t.AMVisStatus = 'OPEN' AND beginswith(AMVisPriority, 'P1', true) AND t.AMVisAccount.AMVisShortName not in ('Ariba') AND t.AMVisQueue in('APP_MGMT', 'APP_MAINT_L3I', 'APP_MAINT_L2P', 'APP_MAINT_L3P') and t.AMVisIsAMSTicket!=false AND t.AMVisSubStatus !='Duplicate'");
data.append("useSQL", "");
...
var data = new FormData();
data.append("query", "SELECT count() FROM AMVisTicket WHERE AMVisDateClosed IS NULL AND CurrentDate() - AMVisDateCreated < 1 AND AMVisPriority='P1 - VERY HIGH' and AMVisAssignedTeam ='GS APP MGMT' AND AMVisStatus ='OPEN' AND AMVisAccount.AMVisShortName != 'Ariba' and AMVisIsAMSTicket!=false AND AMVisSubStatus !='Duplicate'");
data.append("useSQL", "");
data.append("type", "text");
...
var data = new FormData();
data.append("query", "Select count(*) FROM config.amvis.core.AMVisTicket t JOIN config.amvis.core.AMVisAccount acc USING t.AMVisAccount JOIN ariba.user.core.User as AssignedTo using t.AMVisAssignedTo WHERE t.AMVisStatus = 'OPEN' AND t.AMVisAssignedTeam = 'GS APP MGMT' AND beginswith(AMVisPriority, 'P2', true) AND t.AMVisAccount.AMVisShortName not in ('Ariba') UNION ALL Select count(*) FROM config.amvis.core.AMVisTicket t JOIN config.amvis.core.AMVisAccount acc USING t.AMVisAccount WHERE t.AMVisStatus = 'OPEN' AND beginswith(AMVisPriority, 'P2', true) AND t.AMVisAccount.AMVisShortName not in ('Ariba') AND t.AMVisQueue in('APP_MGMT', 'APP_MAINT_L3I', 'APP_MAINT_L2P', 'APP_MAINT_L3P') and t.AMVisIsAMSTicket!=false AND t.AMVisSubStatus !='Duplicate'");
data.append("useSQL", "");
data.append("type", "text");
...
var data = new FormData();
data.append("query", "SELECT count() FROM AMVisTicket WHERE AMVisDateClosed IS NULL AND CurrentDate() - AMVisDateCreated < 1 AND AMVisPriority='P2 - HIGH' and AMVisAssignedTeam ='GS APP MGMT' AND AMVisStatus ='OPEN' AND AMVisAccount.AMVisShortName != 'Ariba' and AMVisIsAMSTicket!=false AND AMVisSubStatus !='Duplicate' ");
data.append("useSQL", "");
data.append("type", "text");
...
var data = new FormData();
data.append("query", "Select count(*) FROM config.amvis.core.AMVisTicket t JOIN config.amvis.core.AMVisAccount acc USING t.AMVisAccount JOIN ariba.user.core.User as AssignedTo using t.AMVisAssignedTo WHERE t.AMVisStatus = 'OPEN' AND t.AMVisAssignedTeam = 'GS APP MGMT' AND beginswith(AMVisPriority, 'P3', true) AND t.AMVisAccount.AMVisShortName not in ('Ariba') UNION ALL Select count(*) FROM config.amvis.core.AMVisTicket t JOIN config.amvis.core.AMVisAccount acc USING t.AMVisAccount WHERE t.AMVisStatus = 'OPEN' AND beginswith(AMVisPriority, 'P3', true) AND t.AMVisAccount.AMVisShortName not in ('Ariba') and t.AMVisIsAMSTicket!=false AND t.AMVisQueue in('APP_MGMT', 'APP_MAINT_L3I', 'APP_MAINT_L2P', 'APP_MAINT_L3P') AND t.AMVisSubStatus !='Duplicate'");
data.append("useSQL", "");
data.append("type", "text");
...
var data = new FormData();
data.append("query", "SELECT count() FROM AMVisTicket WHERE AMVisDateClosed IS NULL AND CurrentDate() - AMVisDateCreated < 1 AND AMVisPriority='P3 - MEDIUM' and AMVisAssignedTeam ='GS APP MGMT' AND AMVisStatus ='OPEN' and AMVisIsAMSTicket!=false AND AMVisAccount.AMVisShortName != 'Ariba' AND AMVisSubStatus !='Duplicate' ");
data.append("useSQL", "");
data.append("type", "text");
...
var data = new FormData();
data.append("query", "Select count(*) FROM config.amvis.core.AMVisTicket t JOIN config.amvis.core.AMVisAccount acc USING t.AMVisAccount JOIN ariba.user.core.User as AssignedTo using t.AMVisAssignedTo WHERE t.AMVisStatus = 'OPEN' AND t.AMVisAssignedTeam = 'GS APP MGMT' AND beginswith(AMVisPriority, 'P4', true) AND t.AMVisAccount.AMVisShortName not in ('Ariba') UNION ALL Select count(*) FROM config.amvis.core.AMVisTicket t JOIN config.amvis.core.AMVisAccount acc USING t.AMVisAccount WHERE t.AMVisStatus = 'OPEN' AND beginswith(AMVisPriority, 'P4', true) AND t.AMVisAccount.AMVisShortName not in ('Ariba') and t.AMVisIsAMSTicket!=false AND t.AMVisQueue in('APP_MGMT', 'APP_MAINT_L3I', 'APP_MAINT_L2P', 'APP_MAINT_L3P') AND t.AMVisSubStatus !='Duplicate'");
data.append("useSQL", "");
data.append("type", "text");
...
var data = new FormData();
data.append("query", "SELECT count() FROM AMVisTicket WHERE AMVisDateClosed IS NULL AND CurrentDate() - AMVisDateCreated < 1 AND AMVisPriority='P4 - LOW' and AMVisAssignedTeam ='GS APP MGMT' AND AMVisStatus ='OPEN' and AMVisIsAMSTicket!=false AND AMVisAccount.AMVisShortName != 'Ariba' AND AMVisSubStatus !='Duplicate'");
data.append("useSQL", "");
data.append("type", "text");
